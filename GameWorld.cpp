...
void GameWorld::setUpTiles() {
	...
	firstRow.push_back(new GameTile("Texture/water.png", 0, 0, true, true));
	firstRow.push_back(new GameTile("Texture/water.png", 100, 0, true, true));
	firstRow.push_back(new GameTile("Texture/water.png", 200, 0, true, true));
	firstRow.push_back(new GameTile("Texture/water.png", 300, 0, true, true));
	firstRow.push_back(new GameTile("Texture/water.png", 400, 0, true, true));
	firstRow.push_back(new GameTile("Texture/water.png", 500, 0, true, true));
	firstRow.push_back(new GameTile("Texture/water.png", 600, 0, true, true));
	firstRow.push_back(new GameTile("Texture/water.png", 700, 0, true, true));
	tiles.push_back(firstRow);

	std::vector<GameTile*> secondRow;
	secondRow.push_back(new GameTile("Texture/water.png", 0, 100, true, true));
	...
	secondRow.push_back(new GameTile("Texture/water.png", 700, 100, true, true));
	tiles.push_back(secondRow);

	std::vector<GameTile*> thirdRow;
	thirdRow.push_back(new GameTile("Texture/water.png", 0, 200, true, false));
	...
	thirdRow.push_back(new GameTile("Texture/water.png", 700, 200, true, false));
	tiles.push_back(thirdRow);

	std::vector<GameTile*> fourthRow;
	fourthRow.push_back(new GameTile("Texture/water.png", 0, 300, true, false));
	...
	fourthRow.push_back(new GameTile("Texture/water.png", 700, 300, true, false));
	tiles.push_back(fourthRow);

	std::vector<GameTile*> fifthRow;
	fifthRow.push_back(new GameTile("Texture/water.png", 0, 400, true, false));
	...
	fifthRow.push_back(new GameTile("Texture/water.png", 700, 400, true, false));
	tiles.push_back(fifthRow);

	std::vector<GameTile*> sixthRow;
	sixthRow.push_back(new GameTile("Texture/water.png", 0, 500, true, false));
	...
	sixthRow.push_back(new GameTile("Texture/water.png", 700, 500, true, false));
	tiles.push_back(sixthRow);

	std::vector<GameTile*> seventhRow;
	seventhRow.push_back(new GameTile("Texture/water.png", 0, 600, true, false));
	...
	seventhRow.push_back(new GameTile("Texture/water.png", 700, 600, true, false));
	tiles.push_back(seventhRow);

	std::vector<GameTile*> eigthRow;
	eigthRow.push_back(new GameTile("Texture/water.png", 0, 700, true, false));
	eigthRow.push_back(new GameTile("Texture/water.png", 100, 700, true, false));
	eigthRow.push_back(new GameTile("Texture/water.png", 200, 700, true, false));
	eigthRow.push_back(new GameTile("Texture/water.png", 300, 700, true, false));
	eigthRow.push_back(new GameTile("Texture/water.png", 400, 700, true, false));
	eigthRow.push_back(new GameTile("Texture/water.png", 500, 700, true, false));
	eigthRow.push_back(new GameTile("Texture/water.png", 600, 700, true, false));
	eigthRow.push_back(new GameTile("Texture/water.png", 700, 700, true, false));
